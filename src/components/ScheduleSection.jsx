...
import { Calendar, Clock, ExternalLink, ShieldCheck, Terminal, CheckCircle2, ArrowRight, Sparkles, X, Zap, Cpu, Rocket } from 'lucide-react';
...
export default function ScheduleSection() {
  ...
  return (
    <section id="schedule" className="py-24 relative min-h-screen flex items-center">
        ...
        <div className="glass-panel border-white/20 overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)] relative bg-void/95">
          ...
          <div className="bg-black/60 px-5 py-3.5 border-b border-white/15 flex items-center justify-between font-mono text-xs">
            <div className="flex items-center gap-2.5">
              ...
              <span className="ml-2 text-fog/80">bash — schedule_sync.sh — interactive_booking</span>
            </div>
          ...
          <div className="p-6 sm:p-10 font-mono text-sm sm:text-base">
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center justify-between mb-4 text-xs font-mono">
                        ...
                        <span className="text-fog/70 flex items-center gap-1">
                          <Clock size={13} />
                      ...
                      <p className="text-fog text-xs font-sans leading-relaxed mb-6">
                        {option.description}
                      </p>
                    </div>
                    ...
                    <div className="pt-4 border-t border-white/10 flex flex-col gap-2">
                      <div className="flex items-center justify-between text-[11px] text-fog/50 mb-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a
                          ...
                          className="p-3 rounded-xl bg-white/5 hover:bg-white/15 text-fog hover:text-white border border-white/10 transition-colors focus-visible:outline-2 focus-visible:outline-signal-yellow flex items-center justify-center shrink-0"
            ...
            <div className="pt-6 border-t border-white/10 flex items-center justify-between flex-wrap gap-4 text-xs text-fog/50">
              <div className="flex items-center gap-2">
