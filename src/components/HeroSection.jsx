...
import { Terminal, Sparkles, ArrowRight, Play, FileDown } from 'lucide-react';
...
export default function HeroSection({ activeFilter, onSelectFilter }) {
  ...
  return (
    <section id={SECTION_IDS.HERO} className="min-h-screen flex items-center pt-24 pb-16 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center min-w-0">
            ...
            <div className="h-6 flex items-center mb-4">
              <span className="terminal-text text-xs sm:text-sm font-mono tracking-tight flex items-center gap-1.5 truncate">
                <span>{typedText}</span>
            ...
            {activeFilter && (
              <div className="mt-8 p-3 rounded-xl bg-signal-yellow/10 border border-signal-yellow/30 flex items-center justify-between max-w-md animate-fade-in font-mono text-xs">
                <div className="flex items-center gap-2 text-signal-yellow font-semibold truncate">
                  <Sparkles size={14} className="shrink-0" />
                  <span className="truncate">FILTER ACTIVE: [{activeFilter}]</span>
                </div>
                <button
                  onClick={() => onSelectFilter(null)}
                  className="text-fog hover:text-white underline text-[11px] focus-visible:outline-2 focus-visible:outline-signal-yellow shrink-0 ml-2"
          ...
          <div className="lg:col-span-5 w-full min-w-0">
            <div className="glass-panel p-4 sm:p-7 relative overflow-hidden group border-white/15 hover:border-white/25 transition-all duration-500 shadow-[0_10px_40px_rgba(0,0,0,0.7)] w-full min-w-0">
              ...
              <div className="flex items-center justify-between pb-4 mb-4 border-b border-white/10 font-mono text-xs">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="ml-2 text-fog/70 truncate">Developer.json</span>
                </div>
                <div className="text-[11px] text-signal-green flex items-center gap-1 shrink-0">
              ...
              <div className="font-mono text-xs sm:text-sm md:text-base leading-relaxed overflow-x-auto w-full">
                ...
                <div 
                  className="pl-6 py-0.5 flex flex-wrap items-center gap-x-1.5 gap-y-1"
                  role="listbox"
                  aria-label="Filter projects by technology stack token"
                >
                        ...
                        <button
                          ...
                          onKeyDown={(e) => {
                            if (e.key === 'Enter' || e.key === ' ') {
                              e.preventDefault();
                              onSelectFilter(isSelected ? null : tech);
                            }
                          }}
                          role="option"
